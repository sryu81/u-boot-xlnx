...
Tested on Debian 12 and Ubuntu 24.01 LTS
...
`your_tftp_server_ip`   : 10.16.18.12 (for controls lab)
`your_psc_elf_location` : psc/psc.elf 
`your_psc_bit_location` : psc/psc.bit
```
ethaddr=xx:xx:xx:xx:xx:xx
serverip=your_tftp_server_ip
bootdelay=5
autostart=n
autoload=n
memaddr=30000000
elffile=your_psc_elf_location
bitfile=your_psc_bit_location
