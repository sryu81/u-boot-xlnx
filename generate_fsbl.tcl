...
#app create -name fsbl -platform $platform_name -domain standalone_ps7_cortexa9_0 -template {Empty Application}
app create -name fsbl -platform $platform_name -hw $xsa_file -proc {ps7_cortexa9_0} -os {standalone} -template {Empty Application}
...
puts "INFO: Your QSPI-configured 'fsbl.elf' is ready in '$workspace_dir/System/zynq_fsbl/'"
file copy -force $workspace_dir/System/zynq_fsbl/fsbl.elf ./